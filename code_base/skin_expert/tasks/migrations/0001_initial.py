...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Query'
        db.create_table(u'tasks_query', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('episode_no', self.gf('django.db.models.fields.CharField')(max_length=90)),
            ('feedback', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'tasks', ['Query'])

        # Adding model 'Job'
        db.create_table(u'tasks_job', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('episode_no', self.gf('django.db.models.fields.CharField')(max_length=90)),
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='a', max_length=128, null=True, blank=True)),
            ('comments', self.gf('django.db.models.fields.TextField')()),
            ('submitted_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True)),
            ('action', self.gf('django.db.models.fields.CharField')(default='a', max_length=128, null=True, blank=True)),
        ))
        db.send_create_signal(u'tasks', ['Job'])


    def backwards(self, orm):
        # Deleting model 'Query'
        db.delete_table(u'tasks_query')

        # Deleting model 'Job'
        db.delete_table(u'tasks_job')
