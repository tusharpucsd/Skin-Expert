...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.summary'
        db.alter_column(u'tasks_job', 'summary', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Job.summary'
        db.alter_column(u'tasks_job', 'summary', self.gf('django.db.models.fields.TextField')(default='aa'))
