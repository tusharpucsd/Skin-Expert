...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'address_country', 'dial_code', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Country.dial_code'
        db.alter_column(u'address_country', 'dial_code', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 1, 10, 0, 0), max_length=200))
