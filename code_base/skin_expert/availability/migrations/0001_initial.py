...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'availability_occurrence', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('doctor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'availability', ['Occurrence'])

        # Adding unique constraint on 'Occurrence', fields ['doctor', 'date']
        db.create_unique(u'availability_occurrence', ['doctor_id', 'date'])


    def backwards(self, orm):
        # Removing unique constraint on 'Occurrence', fields ['doctor', 'date']
        db.delete_unique(u'availability_occurrence', ['doctor_id', 'date'])

        # Deleting model 'Occurrence'
        db.delete_table(u'availability_occurrence')
    ...
    models = {
        ...
        u'availability.occurrence': {
            'Meta': {'unique_together': "(('doctor', 'date'),)", 'object_name': 'Occurrence'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'doctor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.UserProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
