...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.mobile_code'
        db.add_column(u'users_userprofile', 'mobile_code',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default='11', max_length=10),
                      keep_default=False)

        # Adding field 'UserProfile.phone_code'
        db.add_column(u'users_userprofile', 'phone_code',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default='22', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.mobile_code'
        db.delete_column(u'users_userprofile', 'mobile_code')

        # Deleting field 'UserProfile.phone_code'
        db.delete_column(u'users_userprofile', 'phone_code')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'mobile_code': ('django.db.models.fields.PositiveSmallIntegerField', [], {'max_length': '10'}),
            'mobile_no': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'phone_code': ('django.db.models.fields.PositiveSmallIntegerField', [], {'max_length': '10'}),
