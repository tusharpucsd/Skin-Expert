...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.phone_no'
        db.alter_column(u'users_userprofile', 'phone_no', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'UserProfile.mobile_no'
        db.alter_column(u'users_userprofile', 'mobile_no', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.phone_no'
        db.alter_column(u'users_userprofile', 'phone_no', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'UserProfile.mobile_no'
        db.alter_column(u'users_userprofile', 'mobile_no', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'mobile_no': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
