...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_userprofile', (
            ...
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Role'], null=True, blank=True)),
            ('mobile_no', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('phone_no', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
